...
def generate_launch_description():
  ...
  quantec_launch = IncludeLaunchDescription(PythonLaunchDescriptionSource([FindPackageShare("kuka_kss_rsi_driver"), "/launch", "/startup.launch.py"]), launch_arguments={'robot_model': 'kr210_r2700-2'}.items())
