...
def launch_setup(context, *args, **kwargs):
    ...
    rviz_config_file = get_package_share_directory(
        'kuka_resources') + "/config/planning_{}_axis.rviz".format(dof.perform(context))
    ...
    controller_config = (get_package_share_directory('kuka_resources') +
                         "/config/fake_hardware_config_{}_axis.yaml".format(dof.perform(context)))
